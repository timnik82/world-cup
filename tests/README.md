...
### 1. `validate-claude-docs.test.js`
...
### 3. `validate-schema-accuracy.test.js`
...
```bash
cd tests
node validate-claude-docs.test.js
```

### Run Individual Test Suite
```bash
node tests/validate-claude-docs.test.js
node tests/validate-links.test.js
node tests/validate-schema-accuracy.test.js
```
